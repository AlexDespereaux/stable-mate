...
public class TinyDB {
    ...
    public String putImage(String theFolder, String theImageName, Bitmap theBitmap) {
        ...
        String mFullPath = setupFullPathTinyDB(theImageName);

        if (!mFullPath.equals("")) {
            lastImagePath = mFullPath;
            saveBitmapTinyDB(mFullPath, theBitmap);
        }
    ...
    public boolean putImageWithFullPath(String fullPath, Bitmap theBitmap) {
        return !(fullPath == null || theBitmap == null) && saveBitmapTinyDB(fullPath, theBitmap);
    }
     ...
     */
    private String setupFullPathTinyDB(String imageName) {
     ...
     */
    private boolean saveBitmapTinyDB(String fullPath, Bitmap bitmap) {
     ...
     */
    public ArrayList<String> getListStringTinyDB(String key) {
    ...
    public ArrayList<Boolean> getListBoolean(String key) {
        ArrayList<String> myList = getListStringTinyDB(key);
    ...
    public ArrayList<Object> getListObject(String key, Class<?> mClass){
    	...
    	ArrayList<String> objStrings = getListStringTinyDB(key);
    ...
    //added by Marita
    public void removeListObject(String key, ArrayList<Object> objArray){
        checkForNullKey(key);
        Gson gson = new Gson();
        ArrayList<String> objStrings = new ArrayList<String>();
        for(Object obj : objArray){
            //objStrings.add(gson.toJson(obj));
            objStrings.remove(objStrings.size() - 1);
        }
        putListString(key, objStrings);
    }
